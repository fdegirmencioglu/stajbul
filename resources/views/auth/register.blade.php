    ...
    <div class="large-12 columns">
        <div class="content">
            ...
            <div class="alert alert-danger">
                <strong>Oops!</strong> Giriş yaoılırken bazı sorunlarla karşılaşıldı.<br><br>
                <ul>
                        ...
                        <div class="large-12 columns">
                            ...
                            <div class="adi-field">
                                <label>Adı <small>*</small>
                                    <input type="text" class="form-control" name="adi" value="{{ old('adi') }}">
                                </label>
                        ...
                        <div class="large-12 columns">
                            <div class="soyadi-field">
                                <label>Soyadı <small>*</small>
                                    <input type="text" class="form-control" name="soyadi" value="{{ old('soyadi') }}">
                                </label>
                                <small class="error">Doldurulması zorunlu alan. Lütfen yazı giriniz.</small>
                            </div>
                        </div>
